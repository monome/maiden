...
export const updateEditorConfigRequest = (resource, value) => ({ type: UPDATE_EDITOR_CONFIG_REQUEST, resource, value });

export const updateEditorConfigSuccess = (resource, value) => ({ type: UPDATE_EDITOR_CONFIG_SUCCESS, resource, value });

export const editorConfigRequest = (resource) => ({ type: EDITOR_CONFIG_REQUEST, resource });

export const editorConfigSuccess = (resource, value) => ({ type: EDITOR_CONFIG_SUCCESS, resource, value });

export const editorConfigFailure = (resource, error) => ({ type: EDITOR_CONFIG_FAILURE, resource, error });
